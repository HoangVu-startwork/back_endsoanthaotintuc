...
const { getAllBlogs, getBlogByUrl, invalidateAndDeleteXml,createFileHtmlBlogenXml, createFileHtmlEn, getBlogUcademy, createFileHtmlVn, createFileHtmlBlogen, createFileHtmlBlogvn, invalidateAndDelete, filesExistInS3, invalidateAndDeleteVn, filessitemaps } = require('../services/blog-ucademy')
// const { uploadfile } = require('../services/upload');

async function getAllBlog(req, res) {
    try {
        const lang = req.query.lang || 'en';
        const location = 'ucademy';
        const status = STATUS.public;
        const blogs = await getAllBlogs(location, lang, status);
        if (blogs.length === 0) {
...
async function getSitemapsallBlog(req, res) {
    const location = 'ucademy';
    const status = STATUS.public;
    const blogs = await getBlogUcademy(location, status); 

    // Generating the HTML with blog titles
    const blogTitles = blogs.map(blog => `
    <div class="container-card mb-5" data-urlBlog=${blog.urlBlog}' data-blog-id="${blog._id}">
          <a class="blog-back" style="cursor:pointer;" href="/${blog.language}/blog/${blog.urlBlog}.html">
            <div class="card mb-2 blog-card">
              <div class="row g-0 row-blog">
                <div class="col-md-3 ms-xl-2" style="height: auto; align-items: center; display: flex;">
                  <img src=${blog.imageUrl} alt="..." style=" width: 100%; border-radius: 9px; " />
                </div>
              <div class="col-sm-8 blog-back-new ms-xl-2">
                <div class="card-body-01">
                  <h5 class="card-title blog-back-text" data-t>${blog.title}</h5>
                    <div class="col-md-12">
                      <ul class="post-meta mb-0 blog-i-fas">
                        <li class="post-date blog-i-fas"><i class="uil uil-user"></i><span data-t>${blog.author}</span></li>
                        <li class="post-comments  blog-i-fas"><i class="uil uil-eye"></i><span data-t>${blog.view}</span></li>
                      </ul>
                    </div>
                    <p class="card-text blob-text pb-md-0" data-t data-attr-t data-attr-t-interpolate style=' color: #60697b;'>${blog.introduce}</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <head>
      ...
      <meta name="description" data-t data-attr-t data-attr-t-interpolate content-t="Keep yourselves up to date with our latest blogs and news!" />
      <meta name="detail" data-t data-attr-t data-attr-t-interpolate content-t="e-Learning platform" />
      <meta name="keywords" content="ucademy, learning, corporate, lms, online, marketing, saas, paas, training, startup, ucademy" />
      <meta name="author" content="Ucademy" />
    
      <meta name="og:site_name" content="Ucademy" />
      <meta property="og:title" data-t data-attr-t data-attr-t-interpolate content-t="Blog | Ucademy" />
      <meta property="og:url" data-t data-attr-t data-attr-t-interpolate content-t="Blog | Ucademy" />
      <meta property="og:description" data-t data-attr-t data-attr-t-interpolate content-t="Blog | Ucademy" />
      <meta property="og:type" content="website" />
      <meta property="og:image" content="https://ucademy.top/img/blog.png"/>
      <meta property="og:image:alt" data-t data-attr-t data-attr-t-interpolate content-t="Keep yourselves up to date with our latest blogs and news!" />
      <title data-t>Blog | Ucademy</title>
    ...
    fileName = 'sitemaps.html'
    filessitemaps(fileName).then(async ({exists}) => {

        if (exists) {
            await invalidateAndDeleteXml(fileName);
        }

        try {

            const [fileHtmlEn] = await Promise.all([
                createFileHtmlBlogenXml(req.file, fileName, htmlUcademy),
            ]);
    ...
    // Now you can use the generated HTML however you need, like sending it as a response.
    // For instance, if you're working on a web server using Express:
    res.send(htmlUcademy);
}
...
async function getBlog(req, res) {
    ...
    try {
      ...
      <head>
          ...
          <meta name="keywords"
              content="ucademy, learning, corporate, lms, online, marketing, saas, paas, training, startup, ucademy.top">
          <meta name="author" content="Ucademy">
          <meta name="og:site_name" content="Ucademy">
          <meta property="og:title" content="${blog.metaBlog}">
          <meta property="og:url" content="https://ucademy.top/blog/${blog.urlBlog}.html">
          ...
          <title>${blog.titleBlog} || ucademy.top</title>
                                  ...
                                  <li class="nav-item dropdown language-select text-uppercase"><a
                                      ...
                                      <ul class="dropdown-menu">
                                          <li class="nav-item"><a style="width:100%" class="dropdown-item btn-lang"
                                                  data-select="en"
                                                  href="/blog/${blog.urlBlog}.html">En</a>
                                          </li>
                                          <li class="nav-item"><a style="width:100%" class="dropdown-item btn-lang"
                                                  data-select="vn"
                                                  href="/vn/blog/${relatedBlogInfo.urlBlog}.html">Vn</a>
                                          </li>
                                      </ul>
                                  </li>
              ...
              <div class="container py-1 pt-md-1 pb-md-1">
                  <div class="row align-items-center mb-5">
                      ...
                      <div class="col-md-4 col-lg-3 ms-md-auto text-md-end mt-5 mt-md-0"><a
                              class="rounded-pill mb-0 blog-all-text" href="/blog.html">All articles</a></div>
                      <article class="post">
                          <div class="card">
                  ...
                  <div class="blog-card mb-1" id="hover-blog-2"><a class="blog-back"
                          href="/blog/10-tips-for-creating-an-engaging-teaching-video.html">
                  ...
                  <div class="blog-card mb-1" id="hover-blog-3"><a class="blog-back"
                          href="/blog/how-to-build-a-successful-customer-training-program.html">
                          <div class="card-body p-2 pb-0">
                              <div class="row">
                                  <div class="post-header mb-1">
                  ...
                  <div class="blog-card mb-1" id="hover-blog-4"><a class="blog-back"
                          href="/blog/how-to-determine-the-price-of-your-online-courses.html">
                          <div class="card-body p-2 pb-0">
                              <div class="row">
                                  <div class="post-header mb-1">
                  ...
                  <div class="blog-card mb-1" id="hover-blog-5"><a class="blog-back"
                          href="/blog/why-employees-do-not-engage-with-your-training-programs.html">
                          <div class="card-body p-2 pb-0">
                              <div class="row">
                                  <div class="post-header mb-1">
                  ...
                  <div class="blog-text-all"><a class="rounded-pill mb-0 blog-all-text" href="/blog.html">All articles</a>
                  </div>
              </div>
          </section>
          <footer class="bg-light">
                          ...
                          <div class="widget">
                              ...
                              <div class="newsletter-wrapper">
                                  <div id="mc_embed_signup2">
                                      <form action="https://api.ucademy.top/newsletter" method="post"
                        ...
                        <div class="navbar-collapse offcanvas-nav">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#!">Sản phẩm</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a class="dropdown-item" href="/vn/product_overview.html">Tổng
                                                quan sản phẩm</a></li>
                                        <li class="nav-item"><a class="dropdown-item" href="/vn/product_features.html">Tính
                                                năng sản phẩm</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown"><a class="nav-link" href="/vn/pricing.html">Bảng giá</a></li>
                                <li class="nav-item dropdown"><a class="nav-link" href="/vn/contact.html">Liên hệ</a></li>
                                <li class="nav-item dropdown"><a class="nav-link" href="/vn/blog.html">Blog</a></li>
                            </ul>
                        </div>
                        <div class="navbar-other w-100 d-flex ms-auto">
                            <ul class="navbar-nav flex-row align-items-center ms-auto" data-sm-skip="true">
                                <li class="nav-item dropdown language-select text-uppercase"><a
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a style="width:100%" class="dropdown-item btn-lang"
                                                data-select="en"
                                                href="/blog/${blog.urlBlog}.html">En</a></li>
                                        <li class="nav-item"><a style="width:100%" class="dropdown-item btn-lang"
                                                data-select="vn"
                                                href="/vn/blog/${relatedBlogInfo.urlBlog}.html">Vn</a>
                                        </li>
        ...
        <section class="wrapper bg-light mb-12">
            <div class="container py-1 pt-md-1 pb-md-1">
                <div class="row align-items-center mb-5">
                    ...
                    <div class="col-md-4 col-lg-3 ms-md-auto text-md-end mt-5 mt-md-0"><a
                            class="rounded-pill mb-0 blog-all-text" href="/vn/blog.html">Xem tất cả</a></div>
                    <article class="post">
                        <div class="card">
                            <div class="post-slider card-img-top">
                                <div class="swiper-container dots-over" data-margin="5" data-nav="true" data-dots="true">
                ...
                <div class="blog-card mb-1" id="hover-blog-2"><a class="blog-back"
                        href="/vn/blog/10-meo-de-tao-mot-video-giang-day-hap-dan.html">
                        <div class="card-body p-2 pb-0">
                            <div class="row">
                                <div class="post-header mb-1">
                ...
                <div class="blog-card mb-1" id="hover-blog-3"><a class="blog-back"
                        href="/vn/blog/cach-xay-dung-mot-chuong-trinh-dao-tao-khach-hang-thanh-cong.html">
                        <div class="card-body p-2 pb-0">
                            <div class="row">
                                <div class="post-header mb-1">
                ...
                <div class="blog-card mb-1" id="hover-blog-4"><a class="blog-back"
                        href="/vn/blog/chien-luoc-gia-cho-cac-khoa-hoc-truc-tuyen.html">
                        <div class="card-body p-2 pb-0">
                            <div class="row">
                                <div class="post-header mb-1">
                ...
                <div class="blog-card mb-1" id="hover-blog-5"><a class="blog-back"
                        href="/vn/blog/vi-sao-nhan-vien-khong-muon-tham-gia-chuong-trinh-dao-tao-cua-ban.html">
                        <div class="card-body p-2 pb-0">
                            <div class="row">
                                <div class="post-header mb-1">
                ...
                <div class="blog-text-all"><a class="rounded-pill mb-0 blog-all-text" href="/vn/blog.html">Xem tất cả</a>
                </div>
            </div>
        </section>
        <footer class="bg-light">
                          ...
                          <ul class="navbar-nav flex-row align-items-center ms-auto" data-sm-skip="true">
                              <li class="nav-item dropdown language-select text-uppercase"><a
                                  ...
                                  <ul class="dropdown-menu">
                                      <li class="nav-item"><a style="width:100%" class="dropdown-item btn-lang"
                                              data-select="en"
                                              href="/blog/${relatedBlogInfo.urlBlog}.html">En</a></li>
                                      <li class="nav-item"><a style="width:100%" class="dropdown-item btn-lang"
                                              data-select="vn"
                                              href="/vn/blog/${blog.urlBlog}.html">Vn</a>
                                      </li>
                                  </ul>
                              </li>
                              <li class="nav-item d-none d-md-block"><a class="btn btn-sm btn-primary rounded-pill"
  ...
  <body>
                          ...
                          <ul class="navbar-nav flex-row align-items-center ms-auto" data-sm-skip="true">
                              <li class="nav-item dropdown language-select text-uppercase"><a
                                  ...
                                  <ul class="dropdown-menu">
                                      <li class="nav-item"><a style="width:100%" class="dropdown-item btn-lang"
                                              data-select="en"
                                              href="/blog/${relatedBlogInfo.urlBlog}.html">En</a>
                                      </li>
                                      <li class="nav-item"><a style="width:100%" class="dropdown-item btn-lang"
                                              data-select="vn"
                                              href="/vn/blog/${blog.urlBlog}.html">Vn</a>
    ...
    `;
        ...
        if (blog.language === 'en') {
            ...
            filesExistInS3(fileNameEn, fileNameVn)
                .then(async ({ existsEn, existsVn }) => {
                    if (existsEn) {
                        // If English file exists, invalidate and delete
                        await invalidateAndDelete(fileNameEn);
                    }
        
                    if (existsVn) {
                        // If Vietnamese file exists, invalidate and delete
                        await invalidateAndDeleteVn(fileNameVn);
                    }
        
                    // Create new files
                    try {
                        const [fileHtmlEn, fileHtmlVn] = await Promise.all([
                            createFileHtmlEn(req.file, fileNameEn, htmldist),
                            createFileHtmlVn(req.file, fileNameVn, htmlvn)
                        ]);
        ...
        if (blog.language === 'vn') {
            ...
            filesExistInS3(fileNameEn, fileNameVn)
                .then(async ({ existsEn, existsVn }) => {
                    ...
                    try {
                        const [fileHtmlEn, fileHtmlVn] = await Promise.all([
                            createFileHtmlBlogen(req.file, fileNameEn, htmlblogviewdist),
                            createFileHtmlBlogvn(req.file, fileNameVn, htmldistblog)
                        ]);
